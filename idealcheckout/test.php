			...
			<table border="0" cellpadding="5" cellspacing="0">
				<tr>
					...
					<td width="600"><select name="gateway_code" style="width: 450px;">
						<option value="afterpay">AfterPay - /idealcheckout/configuration/afterpay.php</option>
						<option value="authorizedtransfer">Eenmalige machtiging - /idealcheckout/configuration/authorizedtransfer.php</option>
						<option value="cartebleue">Carte Bleue - /idealcheckout/configuration/cartebleue.php</option>
						<option value="clickandbuy">Click and Buy - /idealcheckout/configuration/clickandbuy.php</option>
						<option value="creditcard">Creditcard - /idealcheckout/configuration/creditcard.php</option>
						<option value="directebanking">Direct E-Banking - /idealcheckout/configuration/directebanking.php</option>
						<option value="ebon">E-Bon - /idealcheckout/configuration/ebon.php</option>
						<option value="fasterpay">FasterPay - /idealcheckout/configuration/fasterpay.php</option>
						<option value="giropay">GiroPay - /idealcheckout/configuration/giropay.php</option>
						<option selected="selected" value="ideal">iDEAL - /idealcheckout/configuration/ideal.php</option>
						<option value="maestro">Maestro - /idealcheckout/configuration/maestro.php</option>
						<option value="mastercard">Mastercard - /idealcheckout/configuration/mastercard.php</option>
						<option value="minitix">MiniTix - /idealcheckout/configuration/minitix.php</option>
						<option value="mistercash">MisterCash - /idealcheckout/configuration/mistercash.php</option>
						<option value="manualtransfer">Handmatige overboeking - /idealcheckout/configuration/manualtransfer.php</option>
						<option value="paypal">PayPal - /idealcheckout/configuration/paypal.php</option>
						<option value="paysafecard">PaySafeCard - /idealcheckout/configuration/paysafecard.php</option>
						<option value="postepay">PostePay - /idealcheckout/configuration/postepay.php</option>
						<option value="visa">Visa - /idealcheckout/configuration/visa.php</option>
						<option value="vpay">VPAY - /idealcheckout/configuration/vpay.php</option>
					</select></td>
				</tr>
				<tr>
