...
<form action="https://www.ideal-checkout.nl/payment/" method="post">
	...
	<input name="url_pending" type="hidden" value="' . htmlspecialchars(idealcheckout_getRootUrl() . 'return.php?transaction_id=' . $this->oRecord['transaction_id'] . '&transaction_code=' . $this->oRecord['transaction_code'] . '&status=PENDING') . '">
