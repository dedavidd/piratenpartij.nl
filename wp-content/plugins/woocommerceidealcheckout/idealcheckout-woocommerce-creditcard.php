<?php
	...
	class woocommerce_idealcheckout_creditcard extends WC_Payment_Gateway
	{
		public function __construct()
		{
			...
			$this->method_title = 'iDEAL Checkout - Credit Card';
			$this->icon = false;
		...
		public function init_form_fields()
		{
			$this->form_fields = array(
				'enabled' => array(
					...
					'type' => 'checkbox',
					'label' => idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'Enable Credit Card Payment'),
					'default' => 'no'
				),
				'title' => array(
		...
		{
?>
<h3><?php echo idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'iDEAL Checkout - Credit Card'); ?></h3>
