<?php
	...
	class woocommerce_idealcheckout_webshopgiftcard extends WC_Payment_Gateway
	{
		public function __construct()
		{
			global $woocommerce;

			$this->id = 'idealcheckout_webshopgiftcard';
			$this->method_title = 'iDEAL Checkout - Webshop Giftcard';
			$this->icon = false;
		...
		public function init_form_fields()
		{
			$this->form_fields = array(
				'enabled' => array(
					...
					'type' => 'checkbox',
					'label' => idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'Enable Webshop Giftcard Payment'),
					'default' => 'no'
				),
				'title' => array(
		...
		{
?>
<h3><?php echo idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'iDEAL Checkout - Webshop Giftcard'); ?></h3>
...
`transaction_log` = NULL;";
	...
	function woocommerce_add_idealcheckout_webshopgiftcard($methods) 
	{
		$methods[] = 'woocommerce_idealcheckout_webshopgiftcard'; 
		return $methods;
	}

	add_filter('woocommerce_payment_gateways', 'woocommerce_add_idealcheckout_webshopgiftcard');
