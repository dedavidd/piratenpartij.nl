<?php
	...
	{
		add_menu_page('iDEAL Checkout', 'iDEAL Checkout', 'manage_options', 'idealcheckout-about', 'idealcheckout_about_html', get_bloginfo('wpurl') . '/idealcheckout/images/ideal_16x16.gif');
...
<div class="wrap">
	...
	require_once(dirname(__FILE__) . '/idealcheckout-woocommerce-cartebleue.php');
	require_once(dirname(__FILE__) . '/idealcheckout-woocommerce-clickandbuy.php');
	...
	require_once(dirname(__FILE__) . '/idealcheckout-woocommerce-ebon.php');
	require_once(dirname(__FILE__) . '/idealcheckout-woocommerce-fasterpay.php');
	require_once(dirname(__FILE__) . '/idealcheckout-woocommerce-giropay.php');
	...
	require_once(dirname(__FILE__) . '/idealcheckout-woocommerce-minitix.php');
	...
	require_once(dirname(__FILE__) . '/idealcheckout-woocommerce-postepay.php');
	...
	require_once(dirname(__FILE__) . '/idealcheckout-woocommerce-webshopgiftcard.php');
