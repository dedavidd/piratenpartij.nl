<?php
	...
	class woocommerce_idealcheckout_giropay extends WC_Payment_Gateway
	{
		public function __construct()
		{
			global $woocommerce;

			$this->id = 'idealcheckout_giropay';
			$this->method_title = 'iDEAL Checkout - GiroPay';
			$this->icon = false;
		...
		public function init_form_fields()
		{
			$this->form_fields = array(
				'enabled' => array(
					...
					'type' => 'checkbox',
					'label' => idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'Enable GiroPay Payment'),
					'default' => 'no'
				),
				'title' => array(
		...
		{
?>
<h3><?php echo idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'iDEAL Checkout - GiroPay'); ?></h3>
...
`transaction_log` = NULL;";
	...
	function woocommerce_add_idealcheckout_giropay($methods) 
	{
		$methods[] = 'woocommerce_idealcheckout_giropay'; 
		return $methods;
	}

	add_filter('woocommerce_payment_gateways', 'woocommerce_add_idealcheckout_giropay');
